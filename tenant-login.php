...
<body>
	...
	<nav>
		<ul>
			...
			<li><a href="tenant.php">SIGN UP</a></li>
...
<form class="form" name="frmRegistration" method="post" action="t-login.php">
	<h2>Tenant login</h2>
...
<button> <a href="tenant-home.php">Foget Password</a></button>
</form>
</div>
</bod/>
</html>
