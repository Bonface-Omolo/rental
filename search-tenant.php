...
if (isset($_POST['search'])) {
	...
	$searchQuery = mysqli_query($con, "select * from tenants where fname like '%$input%'  or lname like '%$input%' or contact like '%$input%'or idnumber like '%$input%'or gender like '%$input%'or email like '%$input%' ");
